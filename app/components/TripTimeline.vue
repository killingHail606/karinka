...
/* Справжня дорога: автобус до Сучави вночі, зустріч зранку, машина до Брашова.
...
const steps = [
  {
    icon: 'bus',
    time: '30 липня, 23:30',
    title: 'Ти сідаєш в автобус',
    text: 'Автобус до Сучави. Займай місце біля вікна, вкривайся і спи — попереду ціла ніч.',
    fill: 'var(--rose)',
  },
  {
    icon: 'moon',
    time: 'десь уночі',
    title: 'Кордон',
    text: 'Розбудять, покажеш паспорт, і можна спати далі. Найнудніша частина дороги — і вона мине швидше, ніж здається.',
    fill: 'var(--sage)',
  },
  {
    icon: 'sunrise',
    time: '31 липня, зранку',
    title: 'Сучава. І я',
