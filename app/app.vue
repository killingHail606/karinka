...
<template>
  <div class="page">
    <header class="hero">
      ...
      <div class="hero__scene">
        ...
        <div class="hero__bear">
          <BrasovBear pose="wave" width="var(--bear-w)" />
    ...
    <main>
      <section class="bruno wrap" aria-labelledby="bruno-title" data-reveal>
        <h2 id="bruno-title" class="bruno__title hand">Знайомся, це Бруно</h2>
        <p class="prose bruno__text">
